...
if (isset($_POST['submit'])) {
    ...
    $name = $_POST['name'];
    $phone = $_POST['phone'];
    superadmin_Model::updateProfile($id, $name, $phone);
}
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                <?php
                $id = $_GET['id'];
                $data = superadmin_Model::getEmpById($id);
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="public/dist/img/avatar.png"
