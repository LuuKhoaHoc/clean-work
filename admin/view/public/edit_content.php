                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-header" href="#settings" data-toggle="tab">Edit content</a>
                                </li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal" method="post"
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-2 col-form-label">Title</label>
                                            <div class="col-sm-10">
                                                <input required type="text" name="name" class="form-control"
                                                       id="inputName2" placeholder="Name" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputAddress" class="col-sm-2 col-form-label">Content</label>
                                            <div class="col-sm-10">
