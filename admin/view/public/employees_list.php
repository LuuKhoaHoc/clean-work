    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="index.php?c=Superadmin_Management_Action_Controller&a=upgradeRankEmp" method="post">
                            <div class="card-header">
                                <div class="row d-flex align-items-center">
                                    <div class="col-sm-12 col-md-6">
                                        <select class="form-control " name="position" id="position">
                                            <option value="0">--None--</option>
                                            <?php foreach ($data['empRank'] as $emp) { ?>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="d-flex" style="gap: 10px">
                                            <button name="action" value="promote" class="btn-success rounded">Promote</button>
                                            <button name="action" value="demote" class="btn-warning rounded">Demote</button>
                                            <button name="action" value="dismissed" class="btn-danger rounded">Dismissed</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
