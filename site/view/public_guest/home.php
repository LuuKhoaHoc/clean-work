        ...
        <div class="container">
            <div class="row justify-content-lg-center align-items-center">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <p><a href="#">Clean Work</a> is a Bootstrap v.5.1.3 HTML CSS template for free download provided by
                        Tooplate. You can use this layout for any purpose. Images are taken from <a rel="nofollow"
                                                                                                    href="https://www.freepik.com/"
                                                                                                    target="_blank">FreePik</a>
                        and <a rel="nofollow" href="https://worldvectorlogo.com/" target="_blank">WorldVectorLogo</a>
                        websites.</p>
                    <p>You <strong>may not</strong> redistribute this template ZIP file on any other template collection
                        website. Please <a href="https://www.tooplate.com/contact" target="_blank">contact us</a> for
                        more info. Thank you.</p>
                </div>

                <div class="col-lg-6 col-12 custom-block-wrap">
                    <img src="public/images/male-wearing-apron-female-white-t-shirt-smiling-broadly-being-glad-clean.png"
                         class="img-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-5 col-12">
                                <div class="services-image-wrap">
                                    <a href="index.php?c=&a=showServiceDetailAction">
                    ...
                    <div class="services-thumb">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                <div class="services-info mt-4 mt-lg-0 mt-md-0">
                                    <h4 class="services-title mb-1 mb-lg-2">
                                        <a class="services-title-link" href="index.php?c=&a=showServiceDetailAction">Kitchen
                                            Cleaning</a>
                                    </h4>
                    ...
                    <div class="services-thumb mb-lg-0">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                <div class="services-info mt-4 mt-lg-0 mt-md-0">
                                    <h4 class="services-title mb-1 mb-lg-2">
                                        <a class="services-title-link" href="index.php?c=&a=showServiceDetailAction">Car
                                            Washing</a>
                                    </h4>
                    ...
                    <div class="services-thumb mb-lg-0">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                <div class="services-info mt-4 mt-lg-0 mt-md-0">
                                    <h4 class="services-title mb-1 mb-lg-2">
                                        <a class="services-title-link" href="index.php?c=&a=showServiceDetailAction">Factory
                                            Cleaning</a>
                                    </h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-12">
                    <div class="featured-block">
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/images/avatar/happy-customer-01.jpg" class="avatar-image img-fluid">
                    ...
                    <div class="featured-block mb-lg-0">
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/images/avatar/happy-customer-02.jpg" class="avatar-image img-fluid">
                ...
                <div class="col-lg-4 col-12">
                    <div class="featured-block">
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/images/avatar/happy-customer-03.jpg" class="avatar-image img-fluid">
                    ...
                    <div class="featured-block mb-lg-0">
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/images/avatar/happy-customer-04.jpg" class="avatar-image img-fluid">
                ...
                <div class="col-lg-4 col-12">
                    <div class="featured-block">
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/images/avatar/happy-customer-05.jpg" class="avatar-image img-fluid">
                    ...
                    <div class="featured-block mb-lg-0">
                        <div class="d-flex align-items-center mb-3">
                            <img src="public/images/avatar/happy-customer-06.jpg" class="avatar-image img-fluid">
