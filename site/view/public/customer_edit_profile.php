                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="edit-profile">
                                    <form class="form-horizontal" method="post" action="index.php?c=Customer_Account_Controller&a=changeInformation">
                                        <div class="form-group row mb-3">
                                            <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="name" class="form-control" id="inputName" required value="<?= $customerInfo['name'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10">
                                                <input type="email" name="email" class="form-control" id="inputEmail" required value="<?= $customerInfo['email'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label for="inputPhone" class="col-sm-2 col-form-label">Phone</label>
                                            <div class="col-sm-10">
                                                <input type="tel" name="phone" class="form-control" id="inputPhone" required value="<?= $customerInfo['phone'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
