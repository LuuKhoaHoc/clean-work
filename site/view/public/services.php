                            ...
                            <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                <div class="services-info mt-4 mt-lg-0 mt-md-0">
                                    <h4 class="services-title mb-1 mb-lg-2">
                                        <a class="services-title-link" href="index.php?c=Customer_Display_Content_Controller&a=showServiceDetailAction&s=office-cleaning">Office Cleaning</a>
                                    </h4>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        <a href="index.php?c=Customer_Display_Content_Controller&a=showServiceDetailAction&s=office-cleaning" class="custom-btn btn button button--atlas mt-2 ms-auto">
                    ...
                    <div class="services-thumb section-bg mb-lg-0">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                <div class="services-info mt-4 mt-lg-0 mt-md-0">
                                    <h4 class="services-title mb-1 mb-lg-2">
                                        <a class="services-title-link" href="index.php?c=Customer_Display_Content_Controller&a=showServiceDetailAction&s=kitchen-cleaning">Kitchen Cleaning</a>
                                    </h4>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        <a href="index.php?c=Customer_Display_Content_Controller&a=showServiceDetailAction&s=kitchen-cleaning" class="custom-btn btn button button--atlas mt-2 ms-auto">
                                            <span>Learn More</span>
